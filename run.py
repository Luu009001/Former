...
if __name__ == '__main__':
    ...
    parser.add_argument('--model', type=str, default='Proposed_SEA_MGTUgd_ASB',
    ...
    parser.add_argument('--lradj', type=str, default='CARD', help='adjust learning rate')
    ...
    parser.add_argument('--adaptive_filter', type=str2bool, default=True)#adddd
    parser.add_argument('--inverse', action='store_true', help='inverse output data', default=True)######反归一化
